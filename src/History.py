...
class History(QMainWindow):
    def __init__(self):
        super().__init__()
        # print(os.listdir())
        uic.loadUi('./src/history.ui', self)
        self.setButton()
        self.setTable()
    ...
    def addRows(self):
        rows = [{"patient":"something1","Date":"1","Status":"somewhere1","Study":"some1"},
        {"patient":"something2","Date":"2","Status":"somewhere2","Study":"some2"},
        {"patient":"something3","Date":"3","Status":"somewhere3","Study":"some3"}]
